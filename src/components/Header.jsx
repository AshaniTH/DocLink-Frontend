  ...
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10'>
        ...
        <div className='md-w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
            <p className= 'text-3xl md:text-4xl lg:text-5xl text-white font-semibold leading-tight md:leading-tight lg:leading-tight'>Trusted Doctors,<br />One Click Away</p>
            <div className='flex flex-col md:flex-row items-center text-white text-sm font-light'>
                <img className='w-28'  src={assets.group_profiles} alt="" />
                <p className='pl-2 '>Easily browse our list of trusted doctors,<br className ='hidden sm:block'/>
