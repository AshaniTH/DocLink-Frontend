      ...
      <div>
{
  doctors.slice(0,2).map((item,index)=>(
    <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
      <div>
        <img className='w-32 h-32 bg-indigo-50' src={item.image} alt="" />
      </div>
      <div className='flex-1 text-sm text-zinc-600'>
        ...
        <p className='text-xs mt-1'><span className='text-5m text-neutral-700 font-medium'>Date & Time </span>25, September,2025 | 7.30 PM</p>
      </div>
      <div></div>
